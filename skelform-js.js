function SkfFormatFrameGeneric(frame, anim, isReverse, isLoop) {
...
function SkfTimeFrameGeneric(time, anim, isReverse, isLoop) {
  const elapsed = time / 1000
  const frametime = 1 / anim.fps
  const frame = elapsed / frametime
  return SkfFormatFrameGeneric(frame, anim, isReverse, isLoop)
}
...
function SkfAnimateGeneric(bones, anims, frames, smoothFrames) {
...
function SkfConstructGeneric(rawBones, ikRootIds) {
